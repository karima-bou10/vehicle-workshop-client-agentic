...
const translations: Record<LanguageCode, Dictionary> = {
  fr: {
    ...
    'menu.vehicules': 'Véhicules',
    'menu.mecaniciens': 'Mécaniciens',
    'sidebar.user': 'Connecté',
    ...
    'login.subtitle': 'Accès au shell applicatif',
    ...
    'errors.500': 'Erreur serveur. Réessayez plus tard.',
    'dashboard.title': 'Tableau de bord',
    'dashboard.subtitle': 'Vue globale de l\'atelier',
    ...
    'dashboard.synthese.title': 'Synthèse des mécaniciens',
    'dashboard.synthese.subtitle': 'Vue paginée des indicateurs par mécanicien',
    'dashboard.synthese.button': 'Synthèse des mécaniciens',
    'dashboard.synthese.notAvailable': 'Non disponible',
    'dashboard.synthese.duration.format': '{days} j {hours} h',
    'dashboard.synthese.duration.hoursOnly': '{hours} h',
  ...
  en: {
    ...
    'dashboard.synthese.title': 'Mechanic summary',
    'dashboard.synthese.subtitle': 'Paginated per-mechanic indicators',
    'dashboard.synthese.button': 'Mechanic summary',
    'dashboard.synthese.notAvailable': 'Not available',
    'dashboard.synthese.duration.format': '{days}d {hours}h',
    'dashboard.synthese.duration.hoursOnly': '{hours}h',
